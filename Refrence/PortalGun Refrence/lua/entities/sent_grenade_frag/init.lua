...
FRAG_GRENADE_BLIP_FAST_FREQUENCY	= 2
...
local sk_plr_dmg_fraggrenade	= GetConVarNumber( "sk_plr_dmg_fraggrenade","0" );
...
GRENADE_MODEL = "models/weapons/sent_grenade.mdl"
...
function	ENT:BlipSound_5() self.Entity:EmitSound( self.Sound.Blip_5 ); end
...
function ENT:Initialize()
		...
		self.Entity:SetUseType( SIMPLE_USE )	--don't let players spam +use on us, that's rude
		self.Entity:SetModel( "models/weapons/sent_grenade.mdl" )
