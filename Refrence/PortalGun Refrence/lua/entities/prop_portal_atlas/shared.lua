...
elseif GetConVarNumber("portal_color_ATLAS_1") >=1 then
	...
	elseif int == TYPE_ORANGE_ATLAS then
...
local function PlayerPickup( ply, ent )	
	if ent:GetClass() == "prop_portal_atlas" or ent:GetModel() == "models/blackops/portal_sides.mdl" then
		-- print("No Pickup.")
		return false
	end
	if ent:GetClass() == "prop_portal_atlas" or ent:GetModel() == "models/blackops/portal_sides_new.mdl" then
		-- print("No Pickup.")
		return false
	end
end
