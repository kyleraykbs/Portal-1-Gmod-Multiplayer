...
hook.Add("Move PBODY","hpdMoveHook PBODY",ipMove)
...
-- end)
if CLIENT then
	usermessage.Hook("drawOBB PBODY", function(umsg)
...
if SERVER then
	hook.Add("PreCleanupMap", "Remove portals individually PBODY", function()
...
if SERVER then
	hook.Add("DoPlayerDeath", "Remove Portals On Death PBODY", function(victim)
		local blueportal_PBODY = victim:GetNWEntity( "Portal:Blue_PBODY" )
        local orangeportal_PBODY = victim:GetNWEntity( "Portal:Orange_PBODY" )
