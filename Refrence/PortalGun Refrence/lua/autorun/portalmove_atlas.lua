...
hook.Add("Move ATLAS","hpdMoveHook ATLAS",ipMove)
...
-- end)
if CLIENT then
	usermessage.Hook("drawOBB ATLAS", function(umsg)
...
if SERVER then
	hook.Add("PreCleanupMap", "Remove portals individually ATLAS", function()
...
if SERVER then
	hook.Add("DoPlayerDeath", "Remove Portals On Death ATLAS", function(victim)
		local blueportal_ATLAS = victim:GetNWEntity( "Portal:Blue_ATLAS" )
        local orangeportal_ATLAS = victim:GetNWEntity( "Portal:Orange_ATLAS" )
