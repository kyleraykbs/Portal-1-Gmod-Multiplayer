...
if !snd_portal2:GetBool() then 
			self.Weapon:EmitSound( "weapons/portalgun/portalgun_powerup1.wav", 70, 100, .7, CHAN_WEAPON )
		else
			self.Weapon:EmitSound( "weapons/portalgun/portal2/portalgun_powerup1.wav", 70, 100, .7, CHAN_WEAPON )
end
end
...
RunConsoleCommand("portal_portalonly", 0) 
end
